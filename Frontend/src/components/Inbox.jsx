        ...
        <div className='flex items-center gap-1'>
          {
            mailType.map((items, index) => {
              return (
                <button
                  key={index}
                  className={`${mailTypeSelected == index ? 'border-b-4 border-b-blue-600 text-blue-600' : 'border-b-4 border-b-transparent'} flex items-center gap-5 w-52 hover:bg-gray-100 p-4`}
